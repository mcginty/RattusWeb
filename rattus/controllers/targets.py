...
class TargetsController(BaseController):
    ...
    def create(self):
        ...
        # url('targets')
        newtarget = Target(request.params['name'], request.params['color'])
    ...
    def new(self, format='html'):
        ...
        # url('new_target')
        return "<html><body><form method=post action=/targets/create>name: <input name=name /><br />color: <input name=color /><br /><input type=submit></form></body></html>"
